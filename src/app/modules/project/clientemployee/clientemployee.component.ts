...
@Component({
    selector: 'app-clientemployee',
    templateUrl: './clientemployee.component.html',
    styleUrls: ['./clientemployee.component.scss'],
...
export class ClientEmployeeComponent implements OnInit {
    ...
    constructor(
        ...
        this.commonService.User().subscribe((res:any)=>{
            console.log(res)
            this.clientID = res.data._id
