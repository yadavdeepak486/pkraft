...
import { AddEmployeeComponent } from './modules/project/employee/add-employee/add-employee.component';
    ...
    // Admin routes
    {
        ...
        children: [
            ...
            },
            {
                ...
                loadChildren: () =>
                    import(
                        'app/modules/project/client/client.module'
            ...
            },
            {
                ...
                loadChildren: () =>
                    import(
                        'app/modules/project/employee/employee.module'
            ...
            },
            {
                ...
                loadChildren: () =>
                    import(
                        'app/modules/project/clientemployee/clientemployee.module'
                    ).then((m) => m.ClientEmployeeModule),
            },
            {
                path: 'verify',
                loadChildren: () =>
                    import(
                        'app/modules/project/verify/verify.module'
